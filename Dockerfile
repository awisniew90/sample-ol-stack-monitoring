...
# Remove the default quick-start-security.xml and copy a custom quick-start-security.xml with env variables
RUN cd /work/outer-loop-app/src/main/liberty/config/configDropins/defaults && \
    rm -f quick-start-security.xml && \
    curl -sL https://raw.githubusercontent.com/awisniew90/sample-ol-stack-monitoring/main/quick-start-security.xml --output quick-start-security.xml
